...
void static commonInit(const unsigned char *cmdList) {
  ...
  // initialize SSI0
  GPIO_PORTA_AFSEL_R |= 0x1C;           // enable alt funct on PA2,3,4
  GPIO_PORTA_DEN_R |= 0x1C;             // enable digital I/O on PA2,3,4
                                        // configure PA2,3,4 as SSI
  GPIO_PORTA_PCTL_R = (GPIO_PORTA_PCTL_R&0xFFF000FF)+0x000FFF00;
  GPIO_PORTA_AMSEL_R &= ~0x1C;          // disable analog functionality on PA2,3,4
